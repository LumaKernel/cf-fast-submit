...
;(function () {
  ...
  const extensionMap = {3: "program.dpr", 4: "program.pas", 6: "program.php", 7: "program.py", 9: "program.cs", 12: "program.hs", 13: "program.pl", 19: "program.ml", 20: "[^{}]*object\\s+(\\w+).*|$1.scala", 28: "program.d", 31: "a.py", 32: "program.go", 34: "program.js", 36: "[^{}]*public\\s+(final)?\\s*class\\s+(\\w+).*|$2.java", 40: "a.py", 41: "a.py", 43: "program.c", 48: "program.kt", 49: "program.rs", 50: "program.cpp", 51: "program.pas", 52: "program.cpp", 54: "program.cpp", 55: "program.js", 59: "program.cpp", 60: "[^{}]*public\\s+(final)?\\s*class\\s+(\\w+).*|$2.java", 61: "program.cpp", 65: "program.cs", 67: "program.rb", 70: "a.py", 73: "program.cpp", 74:"[^{}]*public\\s+(final)?\\s*class\\s+(\\w+).*|$2.java", 75:"program.rs", 77:"program.kt", 79:"program.cs", 80:"program.c", 83: "program.kt",87:"[^{}]*public\\s+(final)?\\s*class\\s+(\\w+).*|$2.java", 88: "program.kt", 89: "program.cpp",}
